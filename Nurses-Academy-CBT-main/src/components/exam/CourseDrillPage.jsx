...
//   Step 3 — ExamListPage  (/exam/list)
//   Step 4 — ExamSetupPage (/exam/setup)
//   Step 5 — ExamSession   (/exam/session)
...
export default function CourseDrillPage() {
      ...
      <div style={{ padding: '24px', maxWidth: 900 }}>
        <div style={{ marginBottom: 28 }}>
          ...
          <p style={{ color: 'var(--text-muted)', fontSize: 14, margin: 0 }}>
            Choose a nursing specialty to see available courses.
          </p>
        </div>

        <StepIndicator step={1} steps={['Choose Specialty', 'Choose Course', 'Choose Exam', 'Set Up', 'Take Exam']} />
  ...
  return (
    <div style={{ padding: '24px', maxWidth: 900 }}>
      ...
      <StepIndicator step={2} steps={['Choose Specialty', 'Choose Course', 'Choose Exam', 'Set Up', 'Take Exam']} />
        ...
        <div style={styles.courseGrid}>
          {filteredCourses.map(course => (
            <button key={course.id} onClick={() => handleCourseClick(course)}
              ...
              <div style={{ fontSize: 11, color: specialty.color, fontWeight: 600 }}>View Exams →</div>
            </button>
          ))}
        </div>
      )}
